...
<form name="elmoconfig" action="<?=PluginEngine::getLink($plugin, array('action' => 'themen')) ?>" method="POST">
  <table class="zebra" width="100%" cellpadding="2" cellspacing="0" >
	...
	<tr>
      <td colspan="2" class="content_title" style="font-weight:bold;">
        <?= _("Themenliste:") ?>
      </td>
     </tr>
	 <tr>
